...
Tags: comments, notifications, notification, notify, administration, admin, email, plugin
...
1. Upload the folder notify-by-keywords to the /wp-content/plugins/ directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to Settings->Notify by Keywords to specify your keywords.
